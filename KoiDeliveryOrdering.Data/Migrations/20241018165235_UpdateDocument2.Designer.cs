...
namespace KoiDeliveryOrdering.Data.Migrations
{
    ...
    [Migration("20241018165235_UpdateDocument2")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("KoiDeliveryOrdering.Data.Entities.DocumentDetail", b =>
                {
                    ...
                    b.Property<double>("ItemEstimatePrice")
                        .HasColumnType("float")
            ...
            modelBuilder.Entity("KoiDeliveryOrdering.Data.Entities.UserDTO", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("KoiDeliveryOrdering.Data.Entities.SenderInformation", b =>
                {
                    b.HasOne("KoiDeliveryOrdering.Data.Entities.UserDTO", "User")
            ...
            modelBuilder.Entity("UserVoucherPromotion", b =>
                {
                    b.HasOne("KoiDeliveryOrdering.Data.Entities.UserDTO", null)
                        .WithMany()
                        .HasForeignKey("Id")
                        .IsRequired()
