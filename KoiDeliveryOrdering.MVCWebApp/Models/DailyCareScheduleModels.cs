...
{
    public class DailyCareScheduleModels
    {
        ...
        public virtual ICollection<CareLogModel> CareLogs { get; set; } = new List<CareLogModel>();

        public virtual CareTaskModel CareTask { get; set; } = null!;

        public virtual DeliveryOrderDetailModel DeliverOrderDetail { get; set; } = null!;
    }
}
